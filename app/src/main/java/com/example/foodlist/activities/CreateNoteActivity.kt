package com.ahmadfariz.portalwisata.activities
...
import com.ahmadfariz.portalwisata.R
import com.ahmadfariz.portalwisata.database.NoteDatabase
...
class CreateNoteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fabSaveNote.setOnClickListener(View.OnClickListener {
            if (editTextTitle.getText().toString().isEmpty()) {
                Toast.makeText(this@CreateNoteActivity, "Nama Barang Tidak Boleh Kosong", Toast.LENGTH_SHORT).show()
                return@OnClickListener
            } else if (editTextSubTitle.getText().toString().isEmpty() && editTextSubTitle.getText().toString().isEmpty()) {
                Toast.makeText(this@CreateNoteActivity, "Harga Barang Tidak Boleh Kosong", Toast.LENGTH_SHORT).show()
                return@OnClickListener
            }
            ...
            modelNote.noteText = editTextSubTitle.getText().toString()
    ...
    private fun setViewOrUpdateNote() {
        ...
        editTextSubTitle.setText(modelNoteExtra?.noteText)
